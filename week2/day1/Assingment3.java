...
public class Assingment3 {
	...
	public static void main(String[] args) {
		...
		WebElement duplicatecompany= driver.findElement(By.id("createLeadForm_companyName"));
		duplicatecompany.clear();
		duplicatecompany.sendKeys("Dup NAme");
		WebElement firstname= driver.findElement(By.id("createLeadForm_firstName"));
		firstname.clear();
		firstname.sendKeys("Dup FirstNAme");
		driver.findElement(By.name("submitButton")).click();
		String duptitle = driver.getTitle();
		if (duptitle.equals("View Lead | opentaps CRM"))
		{
			System.out.println(title);
			System.out.println("New Dup Lead Created");
		}
		else 
		{
			System.out.println("New Dup Lead not Created");	
		}
